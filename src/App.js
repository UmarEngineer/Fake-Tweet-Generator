    ...
    <>
      <div className="tweet-settings">
        ...
        <ul>
          ...
          <li>
            <label>Avatar</label>
            <label htmlFor="file" style={{color: 'white'}}>Rasm yuklash uchun bosing</label>
            <input type="file" id="file" hidden className="input" onChange={avatarHandle} />
          </li>
          <li>
            <label>Retweet</label>
            <input
          ...
          <li>
            ...
            >
              <option value="1">{langText?.select[0]}</option>
              <option value="0">{langText?.select[1]}</option>
            </select>
          </li>
      ...
      <div className="tweet-container">
        ...
        <div className="fetch-info">
          <input
            type="text"
            value={username}
            placeholder={langText?.writeUsername}
            onChange={e => setUsername(e.target.value)}
          />
          <button onClick={fetchTwitterInfo}>{langText?.getInfo}</button>
        </div>
        ...
        <div className="tweet" ref={tweetRef}>
          ...
          <div className="tweet-stats">
            ...
            <span>
              <b>{formatNumber(quoteTweets)}</b> {langText?.quotes}
            </span>
            <span>
